...
import { registerSeller } from "../services/webServices";
...
class RegistrationSeller extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      email: "",
...
RegistrationSeller.propTypes = {};

function mapStateToProps(state) {
  return state;
}

export default connect(mapStateToProps)(RegistrationSeller);
